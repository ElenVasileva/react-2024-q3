...
const Flyout = () => {
  ...
  return (
    <div className={styles.flyout}>
      <div className={`${checkedItems.length ? styles.shown : ''} ${styles.toShow}  ${theme === 'dark' ? styles.dark : styles.light}`}>
        <div className={styles.content}>
          ...
          <a href={createFile(checkedItems)} download={`${checkedItems.length}_persons.csv`} className={`${styles.button} ${theme === 'dark' ? styles.buttonDark : styles.buttonLight}`}>
            Download
          </a>
        </div>
      </div>
